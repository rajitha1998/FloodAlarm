package com.example.rajitha.floodalarm;

/**
 * Created by Rajitha on 8/28/2018.
 */
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            finish();
                            startActivity(new Intent(getApplicationContext(), MainActivity.class));
                            Toast.makeText(ProfileActivity.this,"Registered Sucessfully",Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(ProfileActivity.this,"Resigtration Failed, Please try again",
